/**
 * 
 * Menyatakan sub class spesific class bernama Serpentes yaitu inheritance dari
 * class abstract Monster dan Meng-override method dari class Monster
 * 
 * @author Nazwa Salsabila
 * @version 19.11.2023
 */
public class Serpentes extends Monster {
    private int nilai;
    private String nama;
     ...
     * @param nama
     */
    public Serpentes(int nilai, String nama) {
        this.nilai = nilai;
        this.nama = nama;
    }
