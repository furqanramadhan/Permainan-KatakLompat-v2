...
public class KotakPermainan {
  ...
  private void inisialisasiKotak() {
    ...
    // Create object Koin
    Perunggu koin1 = new Perunggu(10);
    Perak koin2 = new Perak(20);
    Emas koin3 = new Emas(30);
    ...
    Aves monster1 = new Aves(-5, "Aves");
    Serpentes monster2 = new Serpentes(-10, "Serpentes");
    Aligator monster3 = new Aligator(-15, "Aligator");
